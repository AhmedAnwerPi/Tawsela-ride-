      ...
      body: Padding(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              TextFormField(controller: _emailController, decoration: const InputDecoration(labelText: 'Email', border: OutlineInputBorder()), validator: (v) => v!.isEmpty ? 'Required' : null,),
              ...
              const SizedBox(height: 16),
              FilledButton(onPressed: _isLoading ? null : _login, child: Text(_isLoading ? 'Loading...' : 'Login')),
            ],
          ),
        ),
      ),
